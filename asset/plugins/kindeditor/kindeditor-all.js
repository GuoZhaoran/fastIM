	...
	init : function(options) {
		...
		var themesPath = _undef(options.themesPath, ''),
			...
			srcScript = ('document.open();' +
				...
				'document.close();'),
			iframeSrc = _IE ? ' src="js:void(function(){' + encodeURIComponent(srcScript) + '}())"' : '';
...
KindEditor.plugin('filemanager', function(K) {
	...
	self.plugin.filemanagerDialog = function(options) {
		...
		var html = [
			...
			'<a class="ke-inline-block" name="moveupLink" href="js:;">' + lang.moveup + '</a>',
			'</div>',
			'<div class="ke-right">',
...
SWFUpload.prototype.callFlash = function (functionName, argumentArray) {
	...
	try {
		returnString = movieElement.CallFunction('<invoke name="' + functionName + '" returntype="js">' + __flash__argumentsToXML(argumentArray, 0) + '</invoke>');
