        ...
        if (!$(_id).hasClass("modal")) {
            ...
            that.$sortModal.off('click', '.btn-primary').on('click', '.btn-primary', function() {
                ...
                if (results.length > 0) {
                    ...
                    if (that.options.sidePagination === 'service') {
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        if (this.options.showMultiSort) {
            ...
            this.$el.on('load-success.bs.table', function() {
                if (!isSingleSort && that.options.sortPriority !== null && typeof that.options.sortPriority === 'object' && that.options.sidePagination !== 'service') {
                    that.onMultipleSort();
                }
            });
